...
def hierarchy():
    Complete_Aircraft = Component(name='Complete Aircraft', geometry=geometry, compute_surface_area_flag=False)
...
X57Hierarchy = hierarchy()
X57Hierarchy.visualize_component_hierarchy(show=False)
...
fuselage = FuselageComp.Fuselage(
    length=fuselage_length, max_height=1.688,
    max_width=1.557, geometry=fuselage, skip_ffd=False)
...
Wing_comp = WingComp.Wing(AR=wing_AR,S_ref=wing_S_ref, taper_ratio=0.2,
                                    geometry=wing,thickness_to_chord=0.17,
                                    thickness_to_chord_loc=0.4, tight_fit_ffd=False, name='WingComp',orientation='horizontal')

flap_AR = csdl.Variable(name="flap_AR", shape=(1, ), value=12.12)
flap_S_ref = csdl.Variable(name="flap_S_ref", shape=(1, ), value=4)
Flaps_comp = WingComp.Wing(AR=flap_AR, S_ref=flap_S_ref, taper_ratio=0.2,
                                    geometry=flap,thickness_to_chord=0.17,
                                    thickness_to_chord_loc=0.4, tight_fit_ffd=False, name='FlapComp', orientation='horizontal')
...
Left_Aileron_comp = WingComp.Wing(AR=aileron_AR, S_ref=aileron_S_ref, taper_ratio=0.2,
                                    geometry=aileronL,thickness_to_chord=0.17,
                                    thickness_to_chord_loc=0.4, tight_fit_ffd=False, name='LeftAileronComp',orientation='horizontal')
Right_Aileron_comp = WingComp.Wing(AR=aileron_AR, S_ref=aileron_S_ref, taper_ratio=0.2,
                                    geometry=aileronR,thickness_to_chord=0.17,
                                    thickness_to_chord_loc=0.4, tight_fit_ffd=False, name='RightAileronComp',orientation='horizontal')
