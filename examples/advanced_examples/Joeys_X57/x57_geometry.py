...
def hierarchy():
    Complete_Aircraft = Component(name='Complete Aircraft', geometry=geometry, compute_surface_area_flag=True)
...
X57Heirarchy.visualize_component_hierarchy(show=False)
